...
func TestUnmarshalConfigWithEnvNoExpand(t *testing.T) {
	// Only if the env variable DEX_EXPAND_ENV is "0", os.ExpandEnv is disabled.
...
func TestUnmarshalConfigWithEnvExpand(t *testing.T) {
	// If the env variable DEX_EXPAND_ENV is unset or has any value except "0", os.ExpandEnv is enabled.
	checkUnmarshalConfigWithEnv(t, "UNSET", true)
	checkUnmarshalConfigWithEnv(t, "", true)
	checkUnmarshalConfigWithEnv(t, "1", true)
	checkUnmarshalConfigWithEnv(t, "anythingExcept0", true)
